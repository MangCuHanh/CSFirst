...
def ShowStartInterface(screen, width, height):
    ...
    title = tfont.render('tro choi lap hinh', True, cfg.RED)
    content1 = cfont.render('Nhan phim H hoac M hoac L de bat dau tro choi', True, cfg.BLUE)
    content2 = cfont.render('H la che do 5*5, M la che do 4*4, L la che do 3*3', True, cfg.BLUE)
